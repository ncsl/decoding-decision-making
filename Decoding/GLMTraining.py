...
for sub in subs:
    ...
    file_paths[sub] = {
        ...
        'out_path_metrics': f'Metrics/Subject{sub}_logistic_visual_card_2_10',
        'out_path_plots': f'Plots/Subject{sub}_logistic_visual_card_2_10'
    }
## %%
...
for sub in subs:
    ...
    data = np.load(file_paths[sub]['data_path'])[trials_to_keep,:,:,40:100] # 40:100 is the time window of interest for visual cue as event
